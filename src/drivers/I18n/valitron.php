...
return [
    ...
    'length'        => __("must be %d characters long"),
    ...
    'lengthBetween' => __("must be between %d and %d characters"),
    'creditCard'    => __("must be a valid credit card number"),
    'lengthMin'     => __("must be at least %d characters long"),
    'lengthMax'     => __("must not exceed %d characters"),
