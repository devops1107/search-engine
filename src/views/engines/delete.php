        ...
        <div class="card-body">
            <div class="form-group">
                <span class="form-text">
                    <?php echo __("Are you sure you want to delete this engine?"); ?>
                    </span>
                </div>
                <div class="form-group">
                    <a href="<?php echo e_attr(url_for('dashboard.engines')); ?>" class="btn btn-outline-primary mr-1">
                        <?php echo __('Nope'); ?></a>
...
extend(
    ...
    [
      ...
      'body_class' => 'engines engines-delete',
