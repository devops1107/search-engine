  ...
  <div class="container">
    ...
    <form method="post" action="?" class="card" data-parsley-validate>
      ...
      <div class="card-body">
            ...
            <input type="text" name="engine_name" id="engine_name" class="form-control" value="<?php echo sp_post('engine_name', $t['engine.engine_name']); ?>" maxlength="200" required>
            ...
            <input type="text" name="engine_cse_id" id="engine_cse_id" class="form-control" value="<?php echo sp_post('engine_cse_id', $t['engine.engine_cse_id']); ?>" maxlength="200" required>
            <div class="form-text text-muted">
        ...
        <div class="form-group">
          ...
          <label class="custom-switch mt-3">
            ...
            <input type="checkbox" id="engine_show_ads" name="engine_show_ads" value="1" class="custom-switch-input" <?php checked(1, (int) sp_post('engine_show_ads', $t['engine.engine_show_ads'])); ?>>
            <span class="custom-switch-indicator"></span>
        ...
        <!--<div class="form-group">
          ...
          <label class="custom-switch mt-3">
            ...
            <input type="checkbox" id="engine_log_search" name="engine_log_search" value="1" class="custom-switch-input" <?php checked(1, (int) sp_post('engine_log_search', $t['engine.engine_log_search'])); ?>>
            <span class="custom-switch-indicator"></span>
